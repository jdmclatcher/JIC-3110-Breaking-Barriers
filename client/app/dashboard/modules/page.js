...
const ModulesPage = () => {
    ...
    const handleDelete = async (module_id) => {
        let response = await fetch(`http://localhost:${process.env.NEXT_PUBLIC_SERVER_PORT}/module/delete?module_id=${module_id}`, {
            method: 'POST',
            mode: 'cors',
            headers: {
                'Content-Type': 'application/json'
    ...
    return (
        <div className="modules-container">
            ...
            <div className="modules-list">
                ...
                <Link href="/dashboard/modules/create" className="create-module-button">Create module</Link>
            </div>
        </div>
    );
}
