const TraineeOptionsForm = ({ questionId, questionType, options, questionResponses, setQuestionResponses }) => {
        ...
        <>
            { questionType === "free_response" ? 
                ...
                options.map((o, i) => {
                    return (
                        <>
                            <input name={`${questionId}`} type="radio" id={o.option_id} value={o.option_id} onChange={handleSelectOption} />
                            <label for={o.option_id}>{o.option_text}</label><br/>
                        </>
                    );
                })
            }
