...
const CreateModulePage = () => {
  ...
  return (
    <div className="modules-container bg-orange-200 h-full">
      ...
      <div className="p-2">
        <h1 className="block uppercase tracking-wide text-gray-700 text-4xl text-center font-bold mb-2">
          Create Module
        </h1>
        <div className="modules-list">
          <form onSubmit={handleSubmit} className="form">
            ...
            <input
              ...
              required
              type="text"
              className="appearance-none block w-full bg-gray-200 text-gray-700 border border-orange-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
            />
            <label
              htmlFor="details"
              className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
            ...
            <div>
              <button
                type="submit"
                className="mt-5 flex-shrink-0 bg-secondary hover:bg-orange-700 border-secondary hover:border-orange-700 text-sm border-4 text-white py-1 px-2 rounded"
              >
                Create Module
              </button>
            </div>
